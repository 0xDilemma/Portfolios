...
public partial class GameCaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.FadminId).HasName("PK__tAdmins__F5DAD0F49EFB216B");

            entity.ToTable("tAdmins");

            entity.HasIndex(e => e.Femail, "UQ__tAdmins__0F13454E79430310").IsUnique();

            entity.HasIndex(e => e.FadminNo, "UQ__tAdmins__F5DB394E1CEC7A6A").IsUnique();
        ...
        {
            entity.HasKey(e => e.FstatusId).HasName("PK__tAdminSt__08155345EDA46E08");
        ...
        {
            entity.HasKey(e => e.FAnnounceId).HasName("PK__tAnnounc__1D5ECEB975946110");
        ...
        {
            entity.HasKey(e => e.FCategoryId).HasName("PK__tAnnounc__53E607B37BD5C28D");

            entity.ToTable("tAnnounceCategories");

            entity.HasIndex(e => e.FCategoryName, "UQ__tAnnounc__11826C731E70532B").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tCategor__3214EC27471B4FDF");
        ...
        {
            entity.HasKey(e => e.FChatId).HasName("PK__tChats__81C1C47F53D5DC17");
        ...
        {
            entity.HasKey(e => e.FconfirmReplyId).HasName("PK__tConfirm__41F322F69D5D75A1");
        ...
        {
            entity.HasKey(e => e.FimageId).HasName("PK__tImages__AD9ECEA740710704");
        ...
        {
            entity.HasKey(e => e.FMessageId).HasName("PK__tMessage__D660247E4F1AFDA2");
        ...
        {
            entity.HasKey(e => e.PortfolioId).HasName("PK__tPortfol__6D3A139D9CE567BB");
        ...
        {
            entity.HasKey(e => e.FuserId).HasName("PK__tPosters__A5C5AA2B3CEA1B9C");
        ...
        {
            entity.HasKey(e => e.FtaskId).HasName("PK__tTasks__807089A7EE5AB4D9");
        ...
        {
            entity.HasKey(e => e.FfollowId).HasName("PK__tTaskFol__A894E1545532BCA6");
        ...
        {
            entity.HasKey(e => e.FuserId).HasName("PK__tUsers__A5C5AA2BE68D323E");
            ...
            entity.HasIndex(e => e.Femail, "UQ__tUsers__0F13454ED50B1594").IsUnique();
            ...
            entity.HasMany(d => d.FuserTypes).WithMany(p => p.Fusers)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("FuserId", "FuserTypeId").HasName("PK__tUserUse__1BCD276970E20F9E");
        ...
        {
            entity.HasKey(e => e.FNotificationId).HasName("PK__tUserNot__A7E1C6B5AA41B180");
        ...
        {
            entity.HasKey(e => e.FuserTypeId).HasName("PK__tUserTyp__E088D42A035FCECD");

            entity.ToTable("tUserTypes");

            entity.HasIndex(e => e.FuserTypeName, "UQ__tUserTyp__EE267F7A58D67F5A").IsUnique();
        ...
        {
            entity.HasKey(e => e.FverificationId).HasName("PK__tVerific__1D00EA7EA19798A0");

            entity.ToTable("tVerifications");

            entity.HasIndex(e => e.Ftoken, "UQ__tVerific__B6A2AFD85EE5CC50").IsUnique();
        ...
        {
            entity.HasKey(e => e.FuserId).HasName("PK__tWorkers__A5C5AA2BF69832E7");
        ...
        {
            entity.HasKey(e => e.FfollowId).HasName("PK__tWorkerF__A894E154F84BACC8");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__TTransac__55433A4B1930AAF4");
